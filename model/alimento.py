...
class Alimento(Base):
  ...
  centesimal = relationship('Alimento_Centesimal', backref=backref("Alimento"), uselist=False)
  graxos = relationship('Alimento_AcidosGraxos', backref=backref("Alimento"), uselist=False)
  aminoacidos = relationship('Alimento_Aminoacidos', backref=backref("Alimento"), uselist=False)
...
class Alimento_AcidosGraxos(Base):
  ...
  ag12_0 = Column(Float, server_default="0.0")
  ag14_0 = Column(Float, server_default="0.0")
  ag16_0 = Column(Float, server_default="0.0")
  ag18_0 = Column(Float, server_default="0.0")
  ag20_0 = Column(Float, server_default="0.0")
  ag22_0 = Column(Float, server_default="0.0")
  ag24_0 = Column(Float, server_default="0.0")
  ag14_1 = Column(Float, server_default="0.0")
  ag16_1 = Column(Float, server_default="0.0")
  ag18_1 = Column(Float, server_default="0.0")
  ag20_1 = Column(Float, server_default="0.0")
  ag18_2n6 = Column(Float, server_default="0.0")
  ag18_3n3 = Column(Float, server_default="0.0")
  ag20_4 = Column(Float, server_default="0.0")
  ag20_5 = Column(Float, server_default="0.0")
  ag22_5 = Column(Float, server_default="0.0")
  ag22_6 = Column(Float, server_default="0.0")
  ag18_1t = Column(Float, server_default="0.0")
  ag18_2t = Column(Float, server_default="0.0")
